                        ...
                        <div class="col text-center mb-3 mb-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select w-50" name="heightUnit">
                                    <option value="centimeter" <?php if (isset($HeightUnit) && $HeightUnit == 'centimeter') {
                                                                    echo "selected";
                                                                } ?>>Centimeter</option>
                                    <option value="inch" <?php if (isset($HeightUnit) && $HeightUnit == 'inch') {
                                                                echo "selected";
                                                            } ?>>Inch</option>
                                    <option value="foot" <?php if (isset($HeightUnit) && $HeightUnit == 'foot' || !isset($HeightUnit)) {
                                                                echo "selected";
                                                            } ?>>Foot</option>
                                </select>
                            </div>
                        ...
                        <div class="col text-center mb-3 mb-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select w-50" name="weightUnit">
                                    <option value="kilogram" <?php if (isset($WeightUnit) && $WeightUnit == 'kilogram') {
                                                                    echo "selected";
                                                                } ?>>Kilogram</option>
                                    <option value="pound" <?php if (isset($WeightUnit) && $WeightUnit == 'pound') {
                                                                echo "selected";
                                                            } ?>>Pound</option>
                                </select>
                            </div>
